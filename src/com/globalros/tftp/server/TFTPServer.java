...
public class TFTPServer {
     ...
     */
    public TFTPServer(VirtualFileSystem vfs, EventListener listener, InetAddress inetAddress) {
        this.vfs = vfs;
    ...
    public void start() {
        ...
        if (tftpLog.isDebugEnabled())
            tftpLog.debug("Starting new TFTP server socket on : " + inetAddress.toString() + ":" + port);

        ss = new TFTPServerSocket(port, poolSize, vfs, listener, inetAddress);
